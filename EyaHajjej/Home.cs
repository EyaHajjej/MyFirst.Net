...
namespace EyaHajjej
{
    public partial class Home : Form
    {
        ...
        {
            Hide();
            modifierBook frm_modif = new modifierBook(); 
            int lignecourrant;
           ...
           frm_modif.text_ISBN.Text = ISBN;
            frm_modif.text_TitreLivre.Text = TitreLivre;
        ...
        {
            MessageBox.Show("Voulez vous fermez l'application"+ MessageBoxButtons.YesNo);
            Close();
        }
    }
    }
